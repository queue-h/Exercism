...
namespace estate_executor {
    ...
    int assemble_code() {
        int red_fragments{garcia::red::code_fragment() + khan::red::code_fragment() + zhang::red::code_fragment()};
        int blue_fragments{garcia::blue::code_fragment() + khan::blue::code_fragment() + zhang::blue::code_fragment()};
        return red_fragments * blue_fragments;
    }
}